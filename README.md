...
A function that is awaiting an action from a user (waiting for an event to be triggered) before executing its code

4. Why would we convert a NodeList into an Array?

by converting to an array, we can then utilize array methods not allowed to be used on an NL

5. What is a component?

block of code that is reuseable
